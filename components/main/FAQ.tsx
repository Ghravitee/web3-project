    ...
    <div id="faq" className="lg:px-20 px-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2  lg:grid-cols-4 lg:grid-rows-2 gap-10 py-10">
        ...
        className="border-[3px] border-[#DBEDFF] p-6 lg:first-box rounded-2xl">
          <h3 className="text-3xl text-white mb-4">What is BOMEOB?</h3>
          <p className="font1 text-[#DBEDFF]">
            Bomeob Is A Memecoin Based On Storytelling, Internet Memes, Launched
            On The Base Blockchain. It Aims To Create A Fun, Engaging, And
            Inclusive Community For Crypto Enthusiasts.
          </p>
        </motion.div>
        ...
        initial="hidden"
        whileInView="show"
        variants={fadeIn("up", "tween", 2.5, 2)}
        viewport={{ once: true}}
        className="border-[3px] border-[#DBEDFF] p-6 lg:second-box rounded-2xl">
          <h3 className="text-3xl text-white mb-4">How do I import the Base RPC into Metamask?</h3>
          <p className="font1 text-[#DBEDFF]">
            Enter The Following Details:
            <br />
             Network Name: BASE New RPC URL:
            Https://Mainnet.Base.Org ‍Chain ID: 84531
            <br />
        ...
        <motion.div
         initial="hidden"
         whileInView="show"
         variants={fadeIn("down", "tween", 3.5, 2)}
         viewport={{ once: true}}
        className="border-[3px] border-[#DBEDFF] p-6 lg:third-box rounded-2xl">
          <h3 className="text-3xl text-white mb-4">Where can I trade BOMEOB?</h3>
          <p className="font1 text-[#DBEDFF]"> 
            BOMEOB Can Be Traded On Decentralized Exchanges (DEXs) That Support
        ...
        <motion.div
         initial="hidden"
         whileInView="show"
         variants={fadeIn("left", "tween", 1.5, 2)}
         viewport={{ once: true}}
        className="border-[3px] border-[#DBEDFF] p-6 lg:fourth-box rounded-2xl">
          <h3 className="text-3xl text-white mb-4">
            Is there a Tax on BOMEOB transactions?
          </h3>
          <p className="font1 text-[#DBEDFF]">
            Yes, BOMEOB Operates On A 1% Tax Round Trip, That Will Be Used For
